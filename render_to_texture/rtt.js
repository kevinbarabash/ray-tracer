...
const size = 300;
simple.buffers.pos = createBuffer(gl.ARRAY_BUFFER, new Float32Array([0, 0, size, 0, size, size, 0, size]), gl.STATIC_DRAW);
...
var tex2 = createTexture(gl.TEXTURE_2D, gl.RGBA, size, size, { minFilter: gl.LINEAR, magFilter: gl.NEAREST });

// create an empty texture
var tex = createTexture(gl.TEXTURE_2D, gl.RGBA, size, size, { minFilter: gl.LINEAR, magFilter: gl.NEAREST });
